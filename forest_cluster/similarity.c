...
#define __PYX_HAVE__forest_cluster__similarity
#define __PYX_HAVE_API__forest_cluster__similarity
#include <string.h>
#include <stdio.h>
...
/* "forest_cluster/similarity.pyx":9
 * np.import_array()
 * 
 ...
 * 
 */
typedef __pyx_t_5numpy_int_t __pyx_t_14forest_cluster_10similarity_DTYPE_t;

/* "forest_cluster/similarity.pyx":10
 * 
 * ctypedef np.int_t DTYPE_t
 * ctypedef np.intp_t ITYPE_t             # <<<<<<<<<<<<<<
 * 
 * 
 */
typedef __pyx_t_5numpy_intp_t __pyx_t_14forest_cluster_10similarity_ITYPE_t;
/* Declarations.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'forest_cluster.similarity' */
static CYTHON_INLINE double __pyx_f_14forest_cluster_10similarity_dist(__pyx_t_14forest_cluster_10similarity_DTYPE_t *, __pyx_t_14forest_cluster_10similarity_DTYPE_t *, __pyx_t_14forest_cluster_10similarity_ITYPE_t); /*proto*/
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_14forest_cluster_10similarity_DTYPE_t = { "DTYPE_t", NULL, sizeof(__pyx_t_14forest_cluster_10similarity_DTYPE_t), { 0 }, 0, IS_UNSIGNED(__pyx_t_14forest_cluster_10similarity_DTYPE_t) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_14forest_cluster_10similarity_DTYPE_t), 0 };
#define __Pyx_MODULE_NAME "forest_cluster.similarity"
extern int __pyx_module_is_main_forest_cluster__similarity;
int __pyx_module_is_main_forest_cluster__similarity = 0;

/* Implementation of 'forest_cluster.similarity' */
...
static const char __pyx_k_matching_dist[] = "matching_dist";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static const char __pyx_k_forest_cluster_similarity[] = "forest_cluster.similarity";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_forest_cluster_similarity_pyx[] = "forest_cluster/similarity.pyx";
...
static PyObject *__pyx_n_s_forest_cluster_similarity;
static PyObject *__pyx_kp_s_forest_cluster_similarity_pyx;
static PyObject *__pyx_n_s_import;
static PyObject *__pyx_n_s_main;
static PyObject *__pyx_n_s_matching_dist;
...
static PyObject *__pyx_pf_14forest_cluster_10similarity_matching_dist(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_X1, PyArrayObject *__pyx_v_X2); /* proto */
...
/* "forest_cluster/similarity.pyx":13
 * 
 * 
...
static CYTHON_INLINE double __pyx_f_14forest_cluster_10similarity_dist(__pyx_t_14forest_cluster_10similarity_DTYPE_t *__pyx_v_x1, __pyx_t_14forest_cluster_10similarity_DTYPE_t *__pyx_v_x2, __pyx_t_14forest_cluster_10similarity_ITYPE_t __pyx_v_size) {
  int __pyx_v_n_eq;
  __pyx_t_14forest_cluster_10similarity_ITYPE_t __pyx_v_j;
  double __pyx_r;
  __pyx_t_14forest_cluster_10similarity_ITYPE_t __pyx_t_1;
  __pyx_t_14forest_cluster_10similarity_ITYPE_t __pyx_t_2;

  /* "forest_cluster/similarity.pyx":15
 * cdef inline double dist(DTYPE_t* x1, DTYPE_t* x2,
 *                          ITYPE_t size) nogil except -1:
 *     cdef int n_eq = 0             # <<<<<<<<<<<<<<
 *     cdef ITYPE_t j
 ...
 */
  ...
  /* "forest_cluster/similarity.pyx":17
 *     cdef int n_eq = 0
 *     cdef ITYPE_t j
 *     for j in range(size):             # <<<<<<<<<<<<<<
 *         n_eq += (x1[j] == x2[j])
 ...
 */
  ...
  for (__pyx_t_2 = 0; __pyx_t_2 < __pyx_t_1; __pyx_t_2+=1) {
    ...
    /* "forest_cluster/similarity.pyx":18
 *     cdef ITYPE_t j
 *     for j in range(size):
 *         n_eq += (x1[j] == x2[j])             # <<<<<<<<<<<<<<
 *     return n_eq * 1. / size
 * 
 */
    __pyx_v_n_eq = (__pyx_v_n_eq + ((__pyx_v_x1[__pyx_v_j]) == (__pyx_v_x2[__pyx_v_j])));
  }

  /* "forest_cluster/similarity.pyx":19
 *     for j in range(size):
 *         n_eq += (x1[j] == x2[j])
 *     return n_eq * 1. / size             # <<<<<<<<<<<<<<
 * 
 * 
 */
  __pyx_r = ((__pyx_v_n_eq * 1.) / __pyx_v_size);
  goto __pyx_L0;
...
/* "forest_cluster/similarity.pyx":22
 * 
 * 
...
/* Python wrapper */
static PyObject *__pyx_pw_14forest_cluster_10similarity_1matching_dist(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_14forest_cluster_10similarity_1matching_dist = {"matching_dist", (PyCFunction)__pyx_pw_14forest_cluster_10similarity_1matching_dist, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_14forest_cluster_10similarity_1matching_dist(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_X1 = 0;
  PyArrayObject *__pyx_v_X2 = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("matching_dist (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_X2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("matching_dist", 1, 2, 2, 1); __PYX_ERR(0, 22, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "matching_dist") < 0)) __PYX_ERR(0, 22, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("matching_dist", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 22, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("forest_cluster.similarity.matching_dist", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_X2), __pyx_ptype_5numpy_ndarray, 1, "X2", 0))) __PYX_ERR(0, 22, __pyx_L1_error)
  __pyx_r = __pyx_pf_14forest_cluster_10similarity_matching_dist(__pyx_self, __pyx_v_X1, __pyx_v_X2);
...
static PyObject *__pyx_pf_14forest_cluster_10similarity_matching_dist(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_X1, PyArrayObject *__pyx_v_X2) {
  __pyx_t_14forest_cluster_10similarity_ITYPE_t __pyx_v_size;
  ...
  __Pyx_RefNannySetupContext("matching_dist", 0);
  ...
  __pyx_pybuffernd_X2.rcbuffer = &__pyx_pybuffer_X2;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X1.rcbuffer->pybuffer, (PyObject*)__pyx_v_X1, &__Pyx_TypeInfo_nn___pyx_t_14forest_cluster_10similarity_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 22, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X2.rcbuffer->pybuffer, (PyObject*)__pyx_v_X2, &__Pyx_TypeInfo_nn___pyx_t_14forest_cluster_10similarity_DTYPE_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 22, __pyx_L1_error)
  }
  ...
  /* "forest_cluster/similarity.pyx":23
 * 
 * def matching_dist(np.ndarray[DTYPE_t, ndim=1] X1, np.ndarray[DTYPE_t, ndim=1] X2):
 *     cdef ITYPE_t size = X1.shape[0]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_size = (__pyx_v_X1->dimensions[0]);

  /* "forest_cluster/similarity.pyx":25
 *     cdef ITYPE_t size = X1.shape[0]
 * 
 *     return dist(<DTYPE_t*> X1.data, <DTYPE_t*> X2.data, size)             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = __pyx_f_14forest_cluster_10similarity_dist(((__pyx_t_14forest_cluster_10similarity_DTYPE_t *)__pyx_v_X1->data), ((__pyx_t_14forest_cluster_10similarity_DTYPE_t *)__pyx_v_X2->data), __pyx_v_size); if (unlikely(__pyx_t_1 == ((double)-1.0))) __PYX_ERR(0, 25, __pyx_L1_error)
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_forest_cluster_similarity, __pyx_k_forest_cluster_similarity, sizeof(__pyx_k_forest_cluster_similarity), 0, 0, 1, 1},
  {&__pyx_kp_s_forest_cluster_similarity_pyx, __pyx_k_forest_cluster_similarity_pyx, sizeof(__pyx_k_forest_cluster_similarity_pyx), 0, 0, 1, 0},
  {&__pyx_n_s_import, __pyx_k_import, sizeof(__pyx_k_import), 0, 0, 1, 1},
  {&__pyx_n_s_main, __pyx_k_main, sizeof(__pyx_k_main), 0, 0, 1, 1},
  {&__pyx_n_s_matching_dist, __pyx_k_matching_dist, sizeof(__pyx_k_matching_dist), 0, 0, 1, 1},
 ...
 * 
 */
  __pyx_tuple__10 = PyTuple_Pack(3, __pyx_n_s_X1, __pyx_n_s_X2, __pyx_n_s_size); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj__11 = (PyObject*)__Pyx_PyCode_New(2, 0, 3, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_forest_cluster_similarity_pyx, __pyx_n_s_matching_dist, 22, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__11)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#endif
{
  ...
  #endif
  if (__pyx_module_is_main_forest_cluster__similarity) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "forest_cluster.similarity")) {
      if (unlikely(PyDict_SetItemString(modules, "forest_cluster.similarity", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "forest_cluster/similarity.pyx":5
 ...
 */
  ...
  /* "forest_cluster/similarity.pyx":7
 * import numpy as np
 * cimport numpy as np
 * np.import_array()             # <<<<<<<<<<<<<<
 * 
 ...
 * 
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_14forest_cluster_10similarity_1matching_dist, NULL, __pyx_n_s_forest_cluster_similarity); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_matching_dist, __pyx_t_1) < 0) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "forest_cluster/similarity.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init forest_cluster.similarity", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init forest_cluster.similarity");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
